...
private:
    enum enMainMenueOptions {
        ...
        eManageUsers = 7, enLoginScreen = 8,enCurrencyExchange = 9,eExit = 10
    };
    ...
    static void _PerfromMainMenueOption(enMainMenueOptions MainMenueOption)
    {
		...
		case enMainMenueOptions::enCurrencyExchange:
			...
			_GoBackToMainMenue();
			break;
            case enMainMenueOptions::enLoginScreen:
			system("cls");
			_ShowLoginScreen();
			_GoBackToMainMenue();
...
public:
    ...
    static void ShowMainMenue()
    {
		...
		cout << setw(37) << left << "" << "\t[8] Login Records.\n";
